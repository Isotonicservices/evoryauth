    ...
    <nav className="fixed top-0 left-0 right-0 z-50 glass-panel border-b border-white/5 py-4 px-6 md:px-12 flex justify-between items-center">
      <Link href="/" className="flex items-center gap-2 group">
        <div className="relative flex items-center justify-center">
          <img src="/logo.png" alt="Logo" className="h-8 w-8 object-contain relative z-10 transition-transform group-hover:scale-110 drop-shadow-[0_0_10px_rgba(59,130,246,0.3)]" />
          <div className="absolute inset-0 bg-blue-500/20 blur-md rounded-full group-hover:bg-purple-500/20 transition-all duration-300" />
        </div>
        <span className="font-outfit text-xl font-bold bg-gradient-to-r from-blue-400 via-indigo-200 to-purple-400 bg-clip-text text-transparent">
          Evory Auth
        </span>
      </Link>
      ...
      <div className="hidden md:flex items-center gap-8 text-sm text-slate-300">
        ...
        <Link href="/status" className="hover:text-blue-400 transition-colors">Status</Link>
      ...
      <div className="flex items-center gap-4">
        ...
        >
          <span className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-500 transition-all duration-300 group-hover:opacity-90" />
