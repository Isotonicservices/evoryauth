    ...
    <nav className="fixed top-0 left-0 right-0 z-50 glass-panel border-b border-white/5 py-4 px-6 md:px-12 flex justify-between items-center">
      <Link href="/" className="flex items-center gap-2 group">
        <div className="relative flex items-center justify-center">
          ...
          <div className="absolute inset-0 bg-red-500/20 blur-md rounded-full group-hover:bg-red-500/20 transition-all duration-300" />
        </div>
      ...
      <div className="flex items-center gap-4">
        ...
        >
          <span className="absolute inset-0 bg-gradient-to-r from-red-500 to-red-600 transition-all duration-300 group-hover:opacity-90" />
